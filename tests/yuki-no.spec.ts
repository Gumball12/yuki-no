...
describe('Batch Processing', () => {
  ...
  it('should use truncated commit hashes', async () => {
    const fullHash = '1234567890abcdef1234567890abcdef12345678';
    vi.mocked(yukiNo.repo.git.exec).mockReturnValue({
      stdout: `${fullHash}|feat: test|2024-01-01T10:00:00+00:00`,
      stderr: '',
      code: 0,
    } as any);
    ...
    // Verify that only 7-character hash is used
    expect(yukiNo.github.batchSearchIssues).toHaveBeenCalledWith(
      expect.anything(),
