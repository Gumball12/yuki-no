import { getResolveId } from '../../src/plugins/core';
...
describe('Plugin version validation', () => {
  ...
  it('extracts resolve id', () => {
    ...
    // Scoped plugins with versions
    expect(getResolveId('@gumball12/yuki-no-plugin-release-tracking@1.0.0')).toBe(
      '@gumball12/yuki-no-plugin-release-tracking',
    );
    expect(getResolveId('@gumball12/yuki-no-plugin-example-plugin@1.0.0')).toBe(
      '@gumball12/yuki-no-plugin-example-plugin',
    );
  });
});
